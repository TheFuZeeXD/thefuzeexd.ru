...
if (navigator.language == "ru" || navigator.language == "ru_RU" || navigator.language == "ru_RU") {
    ...
    projects = {
        ...
        naebverse_description: "NaebVerse — это современный фотохостинг для быстрой загрузки и обмена изображениями. Сервис предлагает бесплатное хранение с поддержкой форматов JPG, PNG, GIF.  Идеален для блогеров, форумов и соцсетей. Один из быстрых и удобных фотохостингов.",
